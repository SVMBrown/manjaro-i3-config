...
values."
  (setq-default
   ...
   '(
     ...
     ;;; User Added Layers
     git
     (org :variables org-projectile-file "/home/svmbrown/org/projects.org")
     markdown
     clojure
     ranger
     nginx
   ...
   dotspacemacs-additional-packages '(org-projectile-helm org-projectile)
...
you should place your code here."
  ...
  (define-key evil-lisp-state-map (kbd "nJ") 'evil-join)
  ...
  (define-key evil-lisp-state-map (kbd "M") (evil-lisp-state-enter-command sp-split-sexp))
  ...
  (global-set-key (kbd "M-L") 'evil-lisp-state)
